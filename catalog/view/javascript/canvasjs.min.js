...
(function() {
            ...
            if ("undefined" !== typeof Blob && new Blob) {
                ...
                try {
                    ...
                    f.dataset.downloadurl = [d, f.download,
                        f.href
                    ].join(":"), f.href = window.URL.createObjectURL(c)
                }
            }
            if (!e) try {
    ...
    function ia(a, c) {
        ...
        if (x(this._options.margin) && a._options.subtitles)
            for (var b =
                    a._options.subtitles, d = 0; d < b.length; d++)
    ...
    function B(a, c, b, d) {
        ...
        if (this._options.stripLines && 0 < this._options.stripLines.length)
            for (this.stripLines = [], c = 0; c < this._options.stripLines.length; c++) this.stripLines.push(new ra(this.chart, this._options.stripLines[c], a.theme, ++this.chart._eventManager.lastObjectId, this));
    ...
    var H = {},
        ...
        ma = 1,
        O = Fa ? ua / ma : 1,
        Ga = window && window.location && window.location.href && window.location.href.indexOf && -1 !== window.location.href.indexOf("canvasjs.com"),
        Oa = {
            reset: {
    ...
    (function() {
        ...
        H.pro = {
            sCH: da[H.fSDec([67, 104, 97, 114, 116])][H.fSDec([99, 114, 101, 100, 105, 116, 72, 114, 101, 102])]
        };
        H.fAWm = function(a) {
    ...
    z.prototype.render = function(a) {
        ...
        if (this._options.subtitles)
            for (a = 0; a < this._options.subtitles.length; a++) this.subtitles = [], b = new pa(this, this._options.subtitles[a]), this.subtitles.push(b),
    ...
    z.prototype.getObjectAtXY = function(a, c, b) {
        ...
        else if (t) d = Ea(a, c, this._eventManager.ghostCtx);
        else
    ...
    z.prototype._plotAreaMouseMove = function(a, c) {
        if (this.isDrag && "none" !== this.plotInfo.axisPlacement) {
            ...
            if ((!e || 2 < Math.abs(b) || !f || 2 < Math.abs(d)) && (this.panEnabled || this.zoomEnabled))
                ...
                }, clearTimeout(g._panTimerId), g._panTimerId = setTimeout(function(b, d, e, f) {
                    return function() {
                        g._zoomPanToSelectedRegion(b,
                            d, e, f, !0) && (g._dispatchRangeEvent("rangeChanging", "pan"), g.render(), g._dispatchRangeEvent("rangeChanged", "pan"), g.dragStartPoint.x = a, g.dragStartPoint.y = c)
                    }
                ...
                var d = e ? this.dragStartPoint.x : this.plotArea.x1,
                    ...
                    p = e ? a - this.dragStartPoint.x : this.plotArea.x2 - this.plotArea.x1,
                    k = f ? c - this.dragStartPoint.y : this.plotArea.y2 -
                    this.plotArea.y1;
                this.validateRegion(d, h, e ? a : this.plotArea.x2 - this.plotArea.x1, f ? c : this.plotArea.y2 - this.plotArea.y1, "xy" !== this.zoomType).isValid && (this.resetOverlayedCanvas(), this.overlaidCanvasCtx.fillStyle = "#99B2B5");
                this.overlaidCanvasCtx.globalAlpha = 0.7;
                this.overlaidCanvasCtx.fillRect(d, h, p, k);
    ...
    z.prototype.validateRegion = function(a, c, b, d, e) {
        ...
        for (f = 0; f < k.length; f++) {
            ...
            if (isFinite(g.dataInfo.minDiff))
                if (!(g.logarithmic &&
                        l / m < Math.pow(g.dataInfo.minDiff, 3) || !g.logarithmic && Math.abs(l - m) < 3 * Math.abs(g.dataInfo.minDiff) || m < g.minimum || l > g.maximum)) p.push(g), n.push({
                    val1: m,
                    val2: l
                }), h = !0;
                else if (!e) {
    ...
    z.prototype.renderIndexLabels = function(a) {
        ...
        for (var c = this.plotArea, b = 0, d = 0, e = 0, f = 0, g = b = f = d = e = 0, h = 0, p = 0; p < this._indexLabels.length; p++) {
            var k = this._indexLabels[p],
                ...
                m, l, q = R("indexLabelFontColor", k.dataPoint, k.dataSeries),
            ...
            var f = R("indexLabelBackgroundColor", k.dataPoint, k.dataSeries),
                ...
                v = null;
            if (0 <= k.dataSeries.type.indexOf("stacked") || "pie" === k.dataSeries.type || "doughnut" === k.dataSeries.type) u = this.getPercentAndTotal(k.dataSeries,
                k.dataPoint);
            if (k.dataSeries.indexLabelFormatter || k.dataPoint.indexLabelFormatter) v = {
            ...
            var w = k.dataPoint.indexLabelFormatter ? k.dataPoint.indexLabelFormatter(v) : k.dataPoint.indexLabel ? this.replaceKeywordsWithValue(k.dataPoint.indexLabel, k.dataPoint, k.dataSeries, null, k.indexKeyword) : k.dataSeries.indexLabelFormatter ? k.dataSeries.indexLabelFormatter(v) : k.dataSeries.indexLabel ?
                this.replaceKeywordsWithValue(k.dataSeries.indexLabel, k.dataPoint, k.dataSeries, null, k.indexKeyword) : null;
            if (null !== w && "" !== w) {
                var u = R("indexLabelPlacement", k.dataPoint, k.dataSeries),
                    v = R("indexLabelOrientation", k.dataPoint, k.dataSeries),
                    t = k.direction,
                    V = k.dataSeries.axisX,
                ...
                if (0 <= n.indexOf("line") || 0 <= n.indexOf("area") || 0 <= n.indexOf("bubble") || 0 <= n.indexOf("scatter")) {
                    ...
                    if (k.dataPoint.x < V.viewportMinimum || k.dataPoint.x >
                        V.viewportMaximum || k.bounds.x1 > c.x2 || k.bounds.x2 < c.x1) continue
                ...
                if ("normal" === this.plotInfo.axisPlacement) {
                    ...
                    m = k.point.x - g / 2;
                    "inside" !== u ? (d = c.y1, e = c.y2, 0 < t ? (l = k.point.y - h - f - b, l < d && (l = "auto" ===
                        ...
                        ("bubble" === n || "scatter" === n) && (l = Math.min(k.point.y + f, c.y2 - h - f))), l = Math.min(l, e - h))
                    ...
                    c.x1), Math.min(k.bounds.x2, c.x2), b = 0 <= n.indexOf("range") ? 0 > t ? Math.max(k.bounds.x1, c.x1) + g / 2 + d : Math.min(k.bounds.x2, c.x2) - g / 2 - d : (Math.max(k.bounds.x1, c.x1) + Math.min(k.bounds.x2, c.x2)) / 2, m = 0 > t ? Math.max(k.point.x, b) - g / 2 : Math.min(k.point.x, b) - g / 2, m = Math.max(m, f));
                "vertical" === v && (l += h);
                q.x = m;
                q.y = l;
                q.render(!0);
                y && ("inside" !== u && (0 > n.indexOf("bar") && k.point.x > c.x1 && k.point.x < c.x2 || !z) && (0 > n.indexOf("column") && k.point.y > c.y1 && k.point.y < c.y2 || !z)) && (a.lineWidth = y, a.strokeStyle = s ? s : "gray", a.setLineDash &&
                    a.setLineDash(D(r, y)), a.beginPath(), a.moveTo(k.point.x, k.point.y), 0 <= n.indexOf("bar") ? a.lineTo(m + (0 < k.direction ? 0 : g), l + ("horizontal" === v ? h : -h) / 2) : 0 <= n.indexOf("column") ? a.lineTo(m + g / 2, l + ((0 < k.direction ? h : -h) + ("horizontal" === v ? h : -h)) / 2) : a.lineTo(m + g / 2, l + ((l < k.point.y ? h : -h) + ("horizontal" === v ? h : -h)) / 2), a.stroke())
            }
        }
        return {
            source: a,
                ...
                if (0 < h.length) {
                    for (var u = !1, r = 0; r < h.length; r++)
                        if (s = h[r].x.getTime ? h[r].x.getTime() : h[r].x, !(s < a.axisX.dataInfo.viewPortMin || s > a.axisX.dataInfo.viewPortMax && (!g.connectNullData || !u)))
                            if ("number" !== typeof h[r].y) 0 < r && !(g.connectNullData || u || q) && (c.stroke(), t &&
                                b.stroke()), u = !0;
                            else {
                                ...
                                q || u ? (!q && g.connectNullData ? (c.setLineDash && (g._options.nullDataLineDashType || p === g.lineDashType && g.lineDashType !== g.nullDataLineDashType) && (c.stroke(), p = g.nullDataLineDashType, c.setLineDash(k)), c.lineTo(s, y), t && b.lineTo(s, y)) : (c.beginPath(), c.moveTo(s, y), t && (b.beginPath(), b.moveTo(s,
                                    y))), u = q = !1) : (c.lineTo(s, y), t && b.lineTo(s, y), 0 == r % 500 && (c.stroke(), c.beginPath(), c.moveTo(s, y), t && (b.stroke(), b.beginPath(), b.moveTo(s, y))));
                                ...
                                if (0 < h[r].markerSize || 0 < g.markerSize) {
                                    var w = g.getMarkerProperties(r, s, y,
                                        c);
                                    d.push(w);
                                    v = C(v);
                                    t && d.push({
    ...
    z.prototype.renderStepLine = function(a) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            for (var d = [], e = 0; e < a.dataSeriesIndexes.length; e++) {
                ...
                if (0 < h.length) {
                    for (var u = !1, r = 0; r < h.length; r++)
                        if (s = h[r].getTime ? h[r].x.getTime() : h[r].x, !(s < a.axisX.dataInfo.viewPortMin || s > a.axisX.dataInfo.viewPortMax && (!g.connectNullData ||
                                !u)))
                            if ("number" !== typeof h[r].y) 0 < r && !(g.connectNullData || u || q) && (c.stroke(), t && b.stroke()), u = !0;
                                ...
                                q || u ? (!q && g.connectNullData ? (c.setLineDash && (g._options.nullDataLineDashType || p === g.lineDashType && g.lineDashType !== g.nullDataLineDashType) && (c.stroke(), p = g.nullDataLineDashType, c.setLineDash(k)),
                                    c.lineTo(s, v), c.lineTo(s, y), t && (b.lineTo(s, v), b.lineTo(s, y))) : (c.beginPath(), c.moveTo(s, y), t && (b.beginPath(), b.moveTo(s, y))), u = q = !1) : (c.lineTo(s, v), t && b.lineTo(s, v), c.lineTo(s, y), t && b.lineTo(s, y), 0 == r % 500 && (c.stroke(), c.beginPath(), c.moveTo(s, y), t && (b.stroke(), b.beginPath(), b.moveTo(s, y))));
                                r < h.length - 1 && (l !== (h[r].lineColor || m) || p !== (h[r].lineDashType || g.lineDashType)) && (c.stroke(), c.beginPath(), c.moveTo(s, y), l = h[r].lineColor || m, c.strokeStyle = l, c.setLineDash && (h[r].lineDashType ? (p = h[r].lineDashType,
                                    c.setLineDash(D(p, g.lineThickness))) : (p = g.lineDashType, c.setLineDash(n))));
                                if (0 < h[r].markerSize || 0 < g.markerSize) v = g.getMarkerProperties(r, s, y, c), d.push(v), w = C(w), t && d.push({
                                    x: s,
                                    y: y,
                                    ctx: b,
                                    type: v.type,
                ...
                if (0 < p.length)
                    for (y = !1, r = 0; r < p.length; r++)
                        if (s = p[r].getTime ? p[r].x.getTime() : p[r].x, !(s < a.axisX.dataInfo.viewPortMin || s > a.axisX.dataInfo.viewPortMax && (!h.connectNullData || !y)))
                            if ("number" !== typeof p[r].y) 0 < r && !y && (h.connectNullData ? b.setLineDash && (0 < u.length && (h._options.nullDataLineDashType ||
                                !p[r - 1].lineDashType)) && (u[u.length - 1].newLineDashArray = n, k = h.nullDataLineDashType) : (c(u), u = [])), y = !0;
                            else {
                                s = a.axisX.convertValueToPixel(s);
                                ...
                                r < p.length - 1 && (q !== (p[r].lineColor || l) || k !== (p[r].lineDashType || h.lineDashType)) && (q = p[r].lineColor || l, u[u.length - 1].newStrokeStyle = q, b.setLineDash && (p[r].lineDashType ? (k =
                                    p[r].lineDashType, u[u.length - 1].newLineDashArray = D(k, h.lineThickness)) : (k = h.lineDashType, u[u.length - 1].newLineDashArray = m)));
    ...
    var N = function(a, c, b, d, e, f, g, h, p, k, n, m, l) {
        ...
        a.globalAlpha = 1;
        0 < g && (l = 0 === g % 2 ? 0 : 0.5,
            a.beginPath(), a.lineWidth = g, a.strokeStyle = h, a.moveTo(c, b), a.rect(c - l, b - l, d - c + 2 * l, e - b + 2 * l), a.stroke());
        a.restore();
        !0 === p && (a.save(), a.beginPath(), a.moveTo(c, b), a.lineTo(c + q, b + q), a.lineTo(d - q, b + q), a.lineTo(d, b), a.closePath(), g = a.createLinearGradient((d + c) / 2, b + q, (d + c) / 2, b), g.addColorStop(0, f), g.addColorStop(1, "rgba(255, 255, 255, .4)"), a.fillStyle = g, a.fill(), a.restore());
        !0 === k && (a.save(), a.beginPath(), a.moveTo(c, e), a.lineTo(c + q, e - q), a.lineTo(d - q, e - q), a.lineTo(d, e), a.closePath(), g = a.createLinearGradient((d +
            c) / 2, e - q, (d + c) / 2, e), g.addColorStop(0, f), g.addColorStop(1, "rgba(255, 255, 255, .4)"), a.fillStyle = g, a.fill(), a.restore());
        !0 === n && (a.save(), a.beginPath(), a.moveTo(c, b), a.lineTo(c + q, b + q), a.lineTo(c + q, e - q), a.lineTo(c, e), a.closePath(), g = a.createLinearGradient(c + q, (e + b) / 2, c, (e + b) / 2), g.addColorStop(0, f), g.addColorStop(1, "rgba(255, 255, 255, 0.1)"), a.fillStyle = g, a.fill(), a.restore());
        !0 === m && (a.save(), a.beginPath(), a.moveTo(d, b), a.lineTo(d - q, b + q), a.lineTo(d - q, e - q), a.lineTo(d, e), g = a.createLinearGradient(d -
    ...
    z.prototype.renderColumn = function(a) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            var b = null,
                ...
                e = this.dataPointMinWidth ? this.dataPointMinWidth : this.dataPointWidth ?
                    ...
                    for (h = 0; h < r.length; h++)
                        if (b = r[h].x.getTime ? r[h].x.getTime() : r[h].x, !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" === typeof r[h].y) {
                            var d = a.axisX.convertValueToPixel(b),
                                ...
                                u = y + m << 0,
                                v;
                            if (a.axisY.logarithmic) g[b] = r[h].y +
                                (g[b] ? g[b] : 0), 0 < g[b] && (p = a.axisY.convertValueToPixel(g[b]), v = e[b] ? e[b] : k, e[b] = p);
                    ...
                    for (h = 0; h < r.length; h++)
                        if (b = r[h].x.getTime ? r[h].x.getTime() : r[h].x, !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" === typeof r[h].y) {
                            var d = a.axisX.convertValueToPixel(b),
                                ...
                                u = y + m << 0,
                                v;
                            if (a.axisY.logarithmic) g[b] = r[h].y + (g[b] ? g[b] : 0), 0 < g[b] && (v = e[b] ? e[b] : k,
                            ...
                            (r[h].indexLabel ||
                                q.indexLabel || r[h].indexLabelFormatter || q.indexLabelFormatter) && this._indexLabels.push({
    ...
    z.prototype.renderStackedBar100 =
        function(a) {
            var c = a.targetCanvasCtx || this.plotArea.ctx;
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var b = null,
                ...
                m = this.dataPointWidth ?
                    this.dataPointWidth : 0.9 * (d.height * (a.axisX.logarithmic ? Math.log(m) / Math.log(a.axisX.range) : Math.abs(m) / Math.abs(a.axisX.range)) / a.plotType.plotUnits.length) << 0;
                this.dataPointMaxWidth && h > n && (h = Math.min(this.dataPointWidth ? this.dataPointWidth : Infinity, n));
                !this.dataPointMaxWidth && (this.dataPointMinWidth && n < h) && (n = Math.max(this.dataPointWidth ? this.dataPointWidth : -Infinity, h));
                m < h && (m = h);
                m > n && (m = n);
                    ...
                    if (0 < r.length) {
                        ...
                        for (h = 0; h < r.length; h++)
                            if (b = r[h].x.getTime ? r[h].x.getTime() : r[h].x, !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" === typeof r[h].y) {
                                ...
                                b = C(b);
                                t && N(this._eventManager.ghostCtx, y, u, p, v, b, 0, null, !1, !1, !1, !1);
                                (r[h].indexLabel || q.indexLabel || r[h].indexLabelFormatter || q.indexLabelFormatter) && this._indexLabels.push({
    ...
    z.prototype.renderArea = function(a) {
        function c() {
            v && (0 < k.lineThickness && b.stroke(), a.axisY.logarithmic || 0 >= a.axisY.viewportMinimum && 0 <= a.axisY.viewportMaximum ? u = y : 0 > a.axisY.viewportMaximum ? u = f.y1 : 0 < a.axisY.viewportMinimum && (u = e.y2), b.lineTo(q, u), b.lineTo(v.x, u), b.closePath(), b.globalAlpha = k.fillOpacity, b.fill(), b.globalAlpha = 1, t && (d.lineTo(q,
                u), d.lineTo(v.x, u), d.closePath(), d.fill()), b.beginPath(), b.moveTo(q, r), d.beginPath(), d.moveTo(q, r), v = {
                x: q,
                y: r
            })
        }
                    ...
                    for (var I = !0; l < n.length; l++)
                        if (s = n[l].x.getTime ? n[l].x.getTime() : n[l].x, !(s < a.axisX.dataInfo.viewPortMin || s > a.axisX.dataInfo.viewPortMax && (!k.connectNullData || !I)))
                            if ("number" !== typeof n[l].y) k.connectNullData || (I || m) || c(), I = !0;
                                ...
                                m || I ? (!m && k.connectNullData ? (b.setLineDash && (k._options.nullDataLineDashType || A === k.lineDashType && k.lineDashType !== k.nullDataLineDashType) && (b.stroke(), A = k.nullDataLineDashType, b.setLineDash(B)),
                                    b.lineTo(q, r), t && d.lineTo(q, r)) : (b.beginPath(), b.moveTo(q, r), t && (d.beginPath(), d.moveTo(q, r)), v = {
                                    x: q,
                                    y: r
                                }), I = m = !1) : (b.lineTo(q, r), t && d.lineTo(q, r), 0 == l % 250 && c());
    ...
    z.prototype.renderSplineArea = function(a) {
            ...
            if (0 < c.length) {
                if (0 < k.lineThickness) {
                    ...
                    for (var g = 0; g < c.length - 3; g += 3)
                        if (b.bezierCurveTo(c[g + 1].x, c[g + 1].y, c[g + 2].x, c[g +
                                2].y, c[g + 3].x, c[g + 3].y), t && d.bezierCurveTo(c[g + 1].x, c[g + 1].y, c[g + 2].x, c[g + 2].y, c[g + 3].x, c[g + 3].y), c[g + 3].newStrokeStyle || c[g + 3].newLineDashArray) b.stroke(), b.beginPath(), b.moveTo(c[g + 3].x, c[g + 3].y), c[g + 3].newStrokeStyle && (b.strokeStyle = c[g + 3].newStrokeStyle), c[g + 3].newLineDashArray && b.setLineDash(c[g + 3].newLineDashArray);
                    b.stroke()
                }
                b.beginPath();
                b.moveTo(c[0].x, c[0].y);
                ...
                for (g = 0; g < c.length - 3; g += 3) b.bezierCurveTo(c[g + 1].x, c[g + 1].y, c[g + 2].x, c[g + 2].y, c[g + 3].x,
                    c[g + 3].y), t && d.bezierCurveTo(c[g + 1].x, c[g + 1].y, c[g + 2].x, c[g + 2].y, c[g + 3].x, c[g + 3].y);
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            for (h = 0; h < a.dataSeriesIndexes.length; h++) {
                ...
                var g = [],
                    m = 0,
                    l, q, r = a.axisY.convertValueToPixel(a.axisY.logarithmic ?
                ...
                if (0 < n.length) {
                    ...
                    for (q = !1; m < n.length; m++)
                        if (l = n[m].x.getTime ? n[m].x.getTime() : n[m].x, !(l < a.axisX.dataInfo.viewPortMin || l > a.axisX.dataInfo.viewPortMax && (!k.connectNullData || !q)))
                            if ("number" !== typeof n[m].y) 0 <
                                m && !q && (k.connectNullData ? b.setLineDash && (0 < u.length && (k._options.nullDataLineDashType || !n[m - 1].lineDashType)) && (u[u.length - 1].newLineDashArray = A, z = k.nullDataLineDashType) : (c(), u = [])), q = !0;
                            else {
                                ...
                                m < n.length - 1 && (x !== (n[m].lineColor || w) || z !== (n[m].lineDashType || k.lineDashType)) && (x =
                                    n[m].lineColor || w, u[u.length - 1].newStrokeStyle = x, b.setLineDash && (n[m].lineDashType ? (z = n[m].lineDashType, u[u.length - 1].newLineDashArray = D(z, k.lineThickness)) : (z = k.lineDashType, u[u.length - 1].newLineDashArray = B)));
    ...
    z.prototype.renderStepArea = function(a) {
        function c() {
            v && (0 < k.lineThickness && b.stroke(), a.axisY.logarithmic || 0 >= a.axisY.viewportMinimum && 0 <= a.axisY.viewportMaximum ?
                u = y : 0 > a.axisY.viewportMaximum ? u = f.y1 : 0 < a.axisY.viewportMinimum && (u = e.y2), b.lineTo(q, u), b.lineTo(v.x, u), b.closePath(), b.globalAlpha = k.fillOpacity, b.fill(), b.globalAlpha = 1, t && (d.lineTo(q, u), d.lineTo(v.x, u), d.closePath(), d.fill()), b.beginPath(), b.moveTo(q, r), d.beginPath(), d.moveTo(q, r), v = {
                    x: q,
                    y: r
                })
        }
                ...
                if (0 < n.length) {
                    ...
                    for (; l < n.length; l++)
                        if (s = n[l].x.getTime ? n[l].x.getTime() : n[l].x, !(s < a.axisX.dataInfo.viewPortMin || s > a.axisX.dataInfo.viewPortMax && (!k.connectNullData || !w))) {
                            var G = r;
                            "number" !== typeof n[l].y ? (k.connectNullData || (w || m) || c(), w = !0) : (q = a.axisX.convertValueToPixel(s), r = a.axisY.convertValueToPixel(n[l].y),
                                m || w ? (!m && k.connectNullData ? (b.setLineDash && (k._options.nullDataLineDashType || B === k.lineDashType && k.lineDashType !== k.nullDataLineDashType) && (b.stroke(), B = k.nullDataLineDashType, b.setLineDash(J)), b.lineTo(q, G), b.lineTo(q, r), t && (d.lineTo(q, G), d.lineTo(q, r))) : (b.beginPath(), b.moveTo(q, r), t && (d.beginPath(), d.moveTo(q, r)), v = {
                                    x: q,
                                    y: r
                                }), w = m = !1) : (b.lineTo(q, G), t && d.lineTo(q, G), b.lineTo(q, r), t && d.lineTo(q, r), 0 == l % 250 && c()), l < n.length - 1 && (A !== (n[l].lineColor || z) || B !== (n[l].lineDashType || k.lineDashType)) && (c(),
                                    A = n[l].lineColor || z, b.strokeStyle = A, b.setLineDash && (n[l].lineDashType ? (B = n[l].lineDashType, b.setLineDash(D(B, k.lineThickness))) : (B = k.lineDashType, b.setLineDash(I)))), G = k.dataPointIds[l], this._eventManager.objectMap[G] = {
                                    id: G,
                                    objectType: "dataPoint",
                                    dataSeriesIndex: p,
                                    dataPointIndex: l,
    ...
    z.prototype.renderStackedArea = function(a) {
        function c() {
            if (!(1 > h.length)) {
                for (0 <
                    v.lineThickness && b.stroke(); 0 < h.length;) {
                    var a = h.pop();
                    b.lineTo(a.x, a.y);
                    t && s.lineTo(a.x, a.y)
                }
            ...
            for (f = 0; f < a.dataSeriesIndexes.length; f++) {
                ...
                if (0 < p.length) {
                    ...
                    for (var I = !0, n = 0; n < p.length; n++) {
                        ...
                        if (!(q < a.axisX.dataInfo.viewPortMin ||
                                q > a.axisX.dataInfo.viewPortMax && (!v.connectNullData || !I)))
                            if ("number" !== typeof G.y) v.connectNullData || (I || y) || c(), I = !0;
                                ...
                                y || I ? (!y && v.connectNullData ? (b.setLineDash && (v._options.nullDataLineDashType || A === v.lineDashType && v.lineDashType !== v.nullDataLineDashType) && (b.stroke(),
                                    A = v.nullDataLineDashType, b.setLineDash(B)), b.lineTo(m, l), t && s.lineTo(m, l)) : (b.beginPath(), b.moveTo(m, l), t && (s.beginPath(), s.moveTo(m, l))), I = y = !1) : (b.lineTo(m, l), t && s.lineTo(m, l), 0 == n % 250 && (c(), b.moveTo(m, l), t && s.moveTo(m, l), h.push({
                                    x: m,
                                    y: r - $
                                })));
                                n < w.length - 1 && (z !== (w[n].lineColor || x) || A !== (w[n].lineDashType || v.lineDashType)) && (c(), b.beginPath(), b.moveTo(m, l), h.push({
                                    x: m,
                                    y: r - $
                                }), z = w[n].lineColor || x, b.strokeStyle = z, b.setLineDash && (w[n].lineDashType ? (A = w[n].lineDashType, b.setLineDash(D(A, v.lineThickness))) :
                                    (A = v.lineDashType, b.setLineDash(J))));
                    ...
                    for (var I = !0, n = 0; n < p.length; n++) {
                        ...
                        if (!(q < a.axisX.dataInfo.viewPortMin ||
                            ...
                            if ("number" !== typeof G.y) v.connectNullData || (I || y) || c(), I = !0;
                                ...
                                var $;
                                $ = 0 !== a.dataPointYSums[q] ? 100 * (G.y / a.dataPointYSums[q]) : 0;
                                m = a.axisX.convertValueToPixel(q);
                                var aa = g[q] ? g[q] : 0;
                                if (a.axisY.logarithmic) {
                                    k[q] = $ + (k[q] ? k[q] : 0);
                                ...
                                g[q] = r - l;
                                y || I ? (!y && v.connectNullData ? (b.setLineDash && (v._options.nullDataLineDashType || A === v.lineDashType &&
                                    v.lineDashType !== v.nullDataLineDashType) && (b.stroke(), A = v.nullDataLineDashType, b.setLineDash(B)), b.lineTo(m, l), t && s.lineTo(m, l)) : (b.beginPath(), b.moveTo(m, l), t && (s.beginPath(), s.moveTo(m, l))), I = y = !1) : (b.lineTo(m, l), t && s.lineTo(m, l), 0 == n % 250 && (c(), b.moveTo(m, l), t && s.moveTo(m, l), h.push({
                                    x: m,
                                    y: r - aa
                                })));
                                n < w.length - 1 && (z !== (w[n].lineColor || x) || A !== (w[n].lineDashType || v.lineDashType)) && (c(), b.beginPath(), b.moveTo(m, l), h.push({
                                    x: m,
                                    y: r - aa
                                }), z = w[n].lineColor || x, b.strokeStyle = z, b.setLineDash && (w[n].lineDashType ?
                                    (A = w[n].lineDashType, b.setLineDash(D(A, v.lineThickness))) : (A = v.lineDashType, b.setLineDash(J))));
                                if (0 <= v.dataPointIndexes[q]) {
    ...
    z.prototype.renderBubble = function(a) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            for (var g = -Infinity, h = Infinity, p = 0; p < a.dataSeriesIndexes.length; p++)
                for (var k = a.dataSeriesIndexes[p], n = this.data[k],
                        m = n.dataPoints, l = 0, d = 0; d < m.length; d++) e = m[d].getTime ? e = m[d].x.getTime() : e = m[d].x, e < a.axisX.dataInfo.viewPortMin || e > a.axisX.dataInfo.viewPortMax || "undefined" === typeof m[d].z || (l = m[d].z, l > g && (g = l), l < h && (h = l));
            for (var q = 25 * Math.PI, b = Math.max(Math.pow(0.25 * Math.min(b.height, b.width) / 2, 2) * Math.PI, q), p = 0; p < a.dataSeriesIndexes.length; p++)
                if (k = a.dataSeriesIndexes[p], n = this.data[k], m = n.dataPoints, 0 < m.length)
                    for (c.strokeStyle = "#4572A7 ", d = 0; d < m.length; d++)
                        if (e = m[d].getTime ? e = m[d].x.getTime() : e = m[d].x, !(e < a.axisX.dataInfo.viewPortMin ||
                                e > a.axisX.dataInfo.viewPortMax) && "number" === typeof m[d].y) {
            ...
            for (var g = 0; g < a.dataSeriesIndexes.length; g++) {
                ...
                if (0 < k.length) {
                    ...
                    for (var n = 0, m = 0, d = 0; d < k.length; d++)
                        if (e = k[d].getTime ? e = k[d].x.getTime() : e = k[d].x, !(e < a.axisX.dataInfo.viewPortMin || e > a.axisX.dataInfo.viewPortMax) && "number" === typeof k[d].y) {
                            e = a.axisX.convertValueToPixel(e);
    ...
    z.prototype.renderCandlestick = function(a) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            var d = null,
                d = this.plotArea,
                e = 0,
                f, g, h, p, k, n, e = this.dataPointMinWidth ?
                ...
                if (0 < s.length)
                    for (var y = 5 < m && r.bevelEnabled ? !0 : !1, e = 0; e < s.length; e++)
                        if (s[e].getTime ? n = s[e].x.getTime() : n = s[e].x, !(n < a.axisX.dataInfo.viewPortMin ||
                            ...
                            "candlestick" === r.type ? (c.moveTo(f - x, h), c.lineTo(f - x, Math.min(g, k)), c.stroke(), c.moveTo(f - x, Math.max(g, k)), c.lineTo(f - x, p), c.stroke(), N(c, u, Math.min(g, k), v, Math.max(g, k), s[e].y[0] <= s[e].y[3] ? r.risingColor : d, w, d, y, y, !1, !1, r.fillOpacity), t && (d = C(z), b.strokeStyle = d, b.moveTo(f -
                    ...
                    for (var l = 5 < h && n.bevelEnabled ? !0 : !1, e = 0; e < m.length; e++)
                        if (m[e].getTime ? g = m[e].x.getTime() : g = m[e].x, !(g < a.axisX.dataInfo.viewPortMin || g > a.axisX.dataInfo.viewPortMax) && null !== m[e].y && m[e].y.length && "number" === typeof m[e].y[0] && "number" === typeof m[e].y[1]) {
                            ...
                            var q = a.axisX.reversed ? b + a.plotType.totalDataSeries * h / 2 - (a.previousDataSeriesCount +
                                    p) * h << 0 : b - a.plotType.totalDataSeries * h / 2 + (a.previousDataSeriesCount + p) * h << 0,
    ...
    z.prototype.renderRangeBar = function(a) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            this.dataPointMaxWidth && e > f && (e = Math.min(this.dataPointWidth ? this.dataPointWidth : Infinity, f));
            !this.dataPointMaxWidth && (this.dataPointMinWidth && f < e) && (f = Math.max(this.dataPointWidth ?
            ...
            for (var k = 0; k < a.dataSeriesIndexes.length; k++) {
                ...
                if (0 < l.length) {
                    ...
                    for (e = 0; e < l.length; e++)
                        if (l[e].getTime ?
                            h = l[e].x.getTime() : h = l[e].x, !(h < a.axisX.dataInfo.viewPortMin || h > a.axisX.dataInfo.viewPortMax) && null !== l[e].y && l[e].y.length && "number" === typeof l[e].y[0] && "number" === typeof l[e].y[1]) {
                            ...
                            d > f && (b = d, d =
                                f, f = b);
                            b = l[e].color ? l[e].color : m._colorSet[e % m._colorSet.length];
                            N(c, d, g, f, r, b, 0, null, q, !1, !1, !1, m.fillOpacity);
                            b = m.dataPointIds[e];
                            this._eventManager.objectMap[b] = {
                                id: b,
                                objectType: "dataPoint",
                        ...
                        if (s = k[m].x.getTime ? k[m].x.getTime() : k[m].x, !(s < a.axisX.dataInfo.viewPortMin || s > a.axisX.dataInfo.viewPortMax && (!p.connectNullData || !B)))
                            if (null !== k[m].y && k[m].y.length && "number" === typeof k[m].y[0] && "number" === typeof k[m].y[1]) {
                                ...
                                n || B ? (p.connectNullData && !n ? (b.setLineDash && (p._options.nullDataLineDashType || x === p.lineDashType && p.lineDashType !== p.nullDataLineDashType) && (g[g.length - 1].newLineDashArray = A, x = p.nullDataLineDashType, b.setLineDash(z)), b.lineTo(l, q), t && d.lineTo(l, q), g.push({
                                    ...
                                    x: l,
                                    y: r
                                }), t && (d.beginPath(), d.moveTo(l, q))), B = n = !1) : (b.lineTo(l, q),
                                    g.push({
                                        x: l,
                                        y: r
                                ...
                                m < k.length - 1 && (w !== (k[m].lineColor || v) || x !== (k[m].lineDashType || p.lineDashType)) && (c(), w = k[m].lineColor || v, g[g.length - 1].newStrokeStyle = w, b.strokeStyle = w, b.setLineDash && (k[m].lineDashType ? (x = k[m].lineDashType, g[g.length - 1].newLineDashArray = D(x, p.lineThickness), b.setLineDash(g[g.length - 1].newLineDashArray)) : (x = p.lineDashType,
                                    g[g.length - 1].newLineDashArray = A, b.setLineDash(A))));
                ...
                if (0 < p.length) {
                    ...
                    for (m = !1; k < p.length; k++)
                        if (n = p[k].x.getTime ? p[k].x.getTime() : p[k].x, !(n < a.axisX.dataInfo.viewPortMin || n > a.axisX.dataInfo.viewPortMax && (!h.connectNullData || !m)))
                            if (null !== p[k].y && p[k].y.length && "number" === typeof p[k].y[0] &&
                                ...
                                k < p.length - 1 && (u !== (p[k].lineColor || y) || v !== (p[k].lineDashType || h.lineDashType)) && (u = p[k].lineColor || y, q[q.length - 1].newStrokeStyle = u, b.setLineDash && (p[k].lineDashType ? (v = p[k].lineDashType,
                                    q[q.length - 1].newLineDashArray = D(v, h.lineThickness)) : (v = h.lineDashType, q[q.length - 1].newLineDashArray = w)));
                                ...
                                if (p[k].indexLabel ||
                                    h.indexLabel || p[k].indexLabelFormatter || h.indexLabelFormatter) this._indexLabels.push({
                                    chartType: "splineArea",
                                    dataPoint: p[k],
                                    dataSeries: h,
                                    indexKeyword: 0,
                                ...
                                m = !1
                            } else 0 < k && !m && (h.connectNullData ? b.setLineDash && (0 < q.length && (h._options.nullDataLineDashType || !p[k - 1].lineDashType)) && (q[q.length -
                                1].newLineDashArray = x, v = h.nullDataLineDashType) : (c(w, y), q = [], r = [])), m = !0;
                    c(w, y);
                    P.drawMarkers(e)
                }
            }
    ...
    var za = function(a, c, b, d, e, f, g, h, p) {
        if (!(0 > b)) {
            ...
            "pie" === e ? (a.beginPath(), a.moveTo(c.x,
                c.y), a.arc(c.x, c.y, b, f, g, !1), a.fillStyle = d, a.strokeStyle = "white", a.lineWidth = 2, a.closePath(), a.fill()) : "doughnut" === e && (a.beginPath(), a.arc(c.x, c.y, b, f, g, !1), 0 <= p && a.arc(c.x, c.y, p * b, g, f, !0), a.closePath(), a.fillStyle = d, a.strokeStyle = "white", a.lineWidth = 2, a.fill());
            a.globalAlpha = 1;
            a.restore()
        }
    };
    z.prototype.renderPie = function(a) {
        function c() {
            if (k && n) {
                for (var a = 0, b = 0, c = 0, d = 0, e = 0; e < n.length; e++) {
                    ...
                    h.midAngle = f;
                    if (h.midAngle > Math.PI / 2 - u && h.midAngle < Math.PI /
                        2 + u) {
                ...
                m = !1;
                for (e = 0; e < n.length; e++) h = q[(d + e) % n.length], 1 < b && (h.midAngle > 3 * Math.PI / 2 - u && h.midAngle < 3 * Math.PI / 2 + u) && (g <= b / 2 && !m ? (h.hemisphere = "left", g++) : (h.hemisphere = "right",
                    m = !0))
            }
        }
        ...
        function b(a) {
            ...
            for (b = 0; b < n.length; b++) {
                ...
                if (d > c) {
                    ...
                    } else if (0 < Math.abs(q[b].center.x - w.x) || 0 < Math.abs(q[b].center.y -
                            w.y)) q[b].center.x = w.x + e * (1 - a), q[b].center.y = w.y + f * (1 - a), g = !0;
            ...
            a.lineJoin = "round";
            for (b = b = 0; b < n.length; b++) c = q[b], c.indexLabelText && (c.indexLabelTextBlock.y -= c.indexLabelTextBlock.height /
        ...
        function f(a, b, c) {
            ...
            if (0 <= a && a < n.length) {
                ...
                0 > b ? k.indexLabelTextBlock.y - k.indexLabelTextBlock.height / 2 > h && k.indexLabelTextBlock.y - k.indexLabelTextBlock.height / 2 + b < h && (b = -(h - (k.indexLabelTextBlock.y - k.indexLabelTextBlock.height / 2 + b))) : k.indexLabelTextBlock.y + k.indexLabelTextBlock.height / 2 < h && k.indexLabelTextBlock.y + k.indexLabelTextBlock.height / 2 + b > l && (b = k.indexLabelTextBlock.y +
                    k.indexLabelTextBlock.height / 2 + b - l);
                ...
                m = e(a);
                l = h = 0;
                0 > b ? (l = "right" === k.hemisphere ? p : m, g = b, null !== l && (p = -b, b = k.indexLabelTextBlock.y - k.indexLabelTextBlock.height / 2 - (q[l].indexLabelTextBlock.y + q[l].indexLabelTextBlock.height / 2), b - p < r && (h = -p, l = f(l, h, c + 1), +l.toFixed(v) > +h.toFixed(v) && (g = b > r ? -(b - r) : -(p - (l - h)))))) : 0 < b && (l = "right" ===
                    k.hemisphere ? m : p, g = b, null !== l && (p = b, b = q[l].indexLabelTextBlock.y - q[l].indexLabelTextBlock.height / 2 - (k.indexLabelTextBlock.y + k.indexLabelTextBlock.height / 2), b - p < r && (h = p, l = f(l, h, c + 1), +l.toFixed(v) < +h.toFixed(v) && (g = b > r ? b - r : p - (h - l)))));
                g && (c = k.indexLabelTextBlock.y + g, b = 0, b = "right" === k.hemisphere ? w.x + Math.sqrt(Math.pow(s, 2) - Math.pow(c - w.y, 2)) : w.x - Math.sqrt(Math.pow(s, 2) - Math.pow(c - w.y, 2)), k.midAngle > Math.PI / 2 - u && k.midAngle < Math.PI / 2 + u ? (h = (a - 1 + q.length) % q.length, h = q[h], a = q[(a + 1 + q.length) % q.length], "left" ===
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            if (0 !== t) {
                ...
                var B = "undefined" !== typeof k.innerRadius && null !== k.innerRadius ? Ia(k.innerRadius, A) : 0.7 * A,
    ...
    M.prototype._wrapText = function() {
        var a = new String(ga(String(this.text))),
            c = [],
            b = this.ctx.font,
            d = 0,
            e = 0;
    ...
    qa.prototype.render = function() {
        ...
        for (var n = 0; n < this.dataSeries.length; n++) {
            ...
            if ("pie" !== m.type && "doughnut" !== m.type && "funnel" !== m.type) {
                var l = m.legendMarkerType ? m.legendMarkerType : "line" !== m.type && "stepLine" !== m.type && "spline" !== m.type && "scatter" !== m.type && "bubble" !== m.type || !m.markerType ? X.getDefaultLegendMarker(m.type) : m.markerType,
                ...
                for (var v = 0; v < m.dataPoints.length; v++) {
                    var w = m.dataPoints[v],
                        l = w.legendMarkerType ? w.legendMarkerType : m.legendMarkerType ? m.legendMarkerType : X.getDefaultLegendMarker(m.type),
    ...
    B.prototype.createLabels =
        function() {
            ...
            if ("axisX" !== this.type || "dateTime" !== this.chart.plotInfo.axisXValueType || this.logarithmic) {
                ...
                for (this.intervalStartPosition = this.getLabelStartPoint(new Date(this.viewportMinimum), this.intervalType, this.interval), e = Aa(new Date(this.viewportMaximum), this.interval, this.intervalType), b = this.intervalStartPosition; b < e; Aa(b, h, this.intervalType)) a = b.getTime(), a = this.labelFormatter ? this.labelFormatter({
                        chart: this.chart._publicChartReference,
                        axis: this._options,
                        value: b,
                        label: this.labels[b] ? this.labels[b] : null
            ...
            if ("bottom" === this._position || "top" === this._position) p = this.logarithmic &&
                ...
                this.chart.width >> 0 : this._options.labelMaxWidth, this.chart.panEnabled || (g = "undefined" === typeof this._options.labelWrap || this.labelWrap ? 0.8 * this.chart.height >> 0 : 1.5 * this.labelFontSize);
            else if ("left" === this._position || "right" === this._position) p = this.logarithmic && !this.equidistantInterval && 2 <= this._labels.length ? this.lineCoordinates.height * Math.log(Math.min(this._labels[this._labels.length - 1].position / this._labels[this._labels.length - 2].position, this._labels[1].position / this._labels[0].position)) / Math.log(this.range) :
            ...
            if (this.labelAutoFit || this._options.labelAutoFit)
                if (x(this.labelAngle) || (this.labelAngle = (this.labelAngle % 360 + 360) % 360, 90 < this.labelAngle && 270 > this.labelAngle ? this.labelAngle -= 180 : 270 <= this.labelAngle && 360 >= this.labelAngle && (this.labelAngle -= 360)), "bottom" === this._position || "top" === this._position)
                    if (f = 0.9 * p >> 0, m = 0, !this.chart.panEnabled && 1 <= this._labels.length) {
                        ...
                        for (b = this.intervalStartPosition < this.viewportMinimum ? 1 : 0; b < this._labels.length; b++)
                            if (a = this._labels[b].textBlock,
                                ...
                                if (this.sessionVariables.labelMaxHeight =
                                    ...
                                    f ? -25 : this.sessionVariables.labelAngle, this.sessionVariables.labelMaxWidth = this._options.labelMaxWidth, this.sessionVariables.labelMaxHeight = g, this.sessionVariables.labelWrap = this.labelWrap);
                                else {
                                    if (x(this._options.labelWrap))
                                        ...
                                        if (d = q.width + c.width >> 0, l = this.labelFontSize, m < f) d - 2 * f > h && (h = d - 2 * f, d >= 2 * f && d < 2.2 * f ? (this.sessionVariables.labelMaxWidth = f, x(this._options.labelFontSize) && 12 < l && (l = Math.floor(12 / 13 * l), a.measureText()), this.sessionVariables.labelFontSize = x(this._options.labelFontSize) ? l : this._options.labelFontSize, this.sessionVariables.labelAngle = this.labelAngle) : d >= 2.2 * f && d < 2.8 * f ? (this.sessionVariables.labelAngle = -25, this.sessionVariables.labelMaxWidth = s, this.sessionVariables.labelFontSize = l) : d >= 2.8 *
                                            f && d < 3.2 * f ? (this.sessionVariables.labelMaxWidth = Math.max(f, m), this.sessionVariables.labelWrap = !0, x(this._options.labelFontSize) && 12 < this.labelFontSize && (this.labelFontSize = Math.floor(12 / 13 * this.labelFontSize), a.measureText()), this.sessionVariables.labelFontSize = x(this._options.labelFontSize) ? l : this._options.labelFontSize, this.sessionVariables.labelAngle = this.labelAngle) : d >= 3.2 * f && d < 3.6 * f ? (this.sessionVariables.labelAngle = -25, this.sessionVariables.labelWrap = !0, this.sessionVariables.labelMaxWidth = s,
                                                ...
                                                g, this.sessionVariables.labelAngle = this.labelAngle));
                                        ...
                                        x(this._options.labelFontSize) ? l : this._options.labelFontSize, this.sessionVariables.labelWrap = !0, this.sessionVariables.labelAngle = -25, this.sessionVariables.labelMaxWidth = s;
                                    else if (0 === h)
                ...
                if (f = x(this._options.labelMaxWidth) ?
    ...
    B.prototype.setViewPortRange = function(a, c) {
        this.sessionVariables.newViewportMinimum =
            this.viewportMinimum = Math.min(a, c);
    ...
    B.prototype.calculateValueToPixelConversionParameters = function(a) {
        ...
        if ("left" === this._position || "right" === this._position) this.logarithmic ? (a.lnLogarithmBase = Math.log(this.logarithmBase), a.pixelPerUnit = (this.reversed ? 1 : -1) * b * a.lnLogarithmBase /
            Math.log(Math.abs(this.range))) : a.pixelPerUnit = (this.reversed ? 1 : -1) * b / Math.abs(this.range), a.reference = this.reversed ? this.lineCoordinates.y1 : this.lineCoordinates.y2;
        this.conversionParameters = a
    };
    B.prototype.convertValueToPixel = function(a) {
        return this.logarithmic ? this.conversionParameters.reference + this.conversionParameters.pixelPerUnit * Math.log(a / this.conversionParameters.minimum) / this.conversionParameters.lnLogarithmBase + 0.5 << 0 : this.conversionParameters.reference + this.conversionParameters.pixelPerUnit *
            (a - this.conversionParameters.minimum) + 0.5 << 0
    };
    B.prototype.calculateAxisParameters = function() {
        if (this.logarithmic) this.calculateLogarithamicAxisParameters();
            ...
            var a = "axisX" === this.type ? "xySwapped" === this.chart.plotInfo.axisPlacement ? 62 : 70 : "xySwapped" === this.chart.plotInfo.axisPlacement ? 50 : 40,
                b = 4;
            "axisX" ===
            this.type && (b = 100 > this.maxWidth ? 3 : 300 > this.maxWidth ? 6 : 600 > this.maxWidth ? 8 : 6);
            var a = Math.max(b, Math.floor(this.maxWidth / a)),
                d, e, f, b = 0;
            if (null === this.viewportMinimum || isNaN(this.viewportMinimum)) this.viewportMinimum = this.minimum;
            if (null === this.viewportMaximum || isNaN(this.viewportMaximum)) this.viewportMaximum = this.maximum;
            "axisX" === this.type ? (d = null !== this.viewportMinimum ? this.viewportMinimum : this.dataInfo.viewPortMin, e = null !== this.viewportMaximum ? this.viewportMaximum : this.dataInfo.viewPortMax, 0 === e -
            ...
            if ("axisX" === this.type && "dateTime" === this.chart.plotInfo.axisXValueType) {
                this.intervalType || (b / 1 <= a ? (this.interval = 1, this.intervalType = "millisecond") : b / 2 <= a ? (this.interval = 2, this.intervalType = "millisecond") : b / 5 <= a ? (this.interval = 5, this.intervalType = "millisecond") : b / 10 <= a ? (this.interval = 10, this.intervalType = "millisecond") :
                    ...
                    b / (2 * E.weekDuration) <= a ? (this.interval = 2, this.intervalType = "week") : b / (3 * E.weekDuration) <= a ? (this.interval = 3, this.intervalType = "week") : b / (1 * E.monthDuration) <= a ? (this.interval = 1, this.intervalType = "month") : b / (2 * E.monthDuration) <= a ? (this.interval = 2, this.intervalType = "month") : b / (3 * E.monthDuration) <= a ? (this.interval = 3, this.intervalType = "month") : b / (6 * E.monthDuration) <= a ? (this.interval = 6, this.intervalType = "month") : (this.interval = b / (1 * E.yearDuration) <= a ? 1 : b / (2 * E.yearDuration) <= a ? 2 : b / (4 * E.yearDuration) <= a ?
                        4 : Math.floor(B.getNiceNumber(b / (a - 1), !0) / E.yearDuration), this.intervalType = "year"));
                ...
                c ? this.autoValueFormatString = "MMM DD YYYY HH:mm" : "year" === this.intervalType ? this.autoValueFormatString = "YYYY" : "month" === this.intervalType ? this.autoValueFormatString = "MMM YYYY" : "week" === this.intervalType ? this.autoValueFormatString = "MMM DD YYYY" :
                ...
                this.interval = this._options &&
                    0 < this._options.interval ? this._options.interval : B.getNiceNumber(b / (a - 1), !0);
                ...
                0 === this.viewportMaximum && 0 === this.viewportMinimum && (0 === this._options.viewportMinimum ? this.viewportMaximum += 10 : 0 === this._options.viewportMaximum &&
                    (this.viewportMinimum -= 10), this._options && "undefined" === typeof this._options.interval && (this.interval = B.getNiceNumber((this.viewportMaximum - this.viewportMinimum) / (a - 1), !0)))
            }
            if (null === this.minimum || null === this.maximum)
                if ("axisX" === this.type ? (d = null !== this.minimum ? this.minimum : this.dataInfo.min, e = null !== this.maximum ? this.maximum : this.dataInfo.max, 0 === e - d && (b = "undefined" === typeof this._options.interval ? 0.4 : this._options.interval, e += b, d -= b), f = Infinity !== this.dataInfo.minDiff ? this.dataInfo.minDiff : 1 <
                        ...
                        this.dataInfo.minDiff ? this.dataInfo.minDiff : 1 < e - d ? 0.5 * Math.abs(e - d) : 1, this.includeZero && (null === this.minimum || isNaN(this.minimum)) && 0 < d && (d = 0), this.includeZero && (null === this.maximum || isNaN(this.maximum)) && 0 > e && (e = 0)), "axisX" === this.type && "dateTime" === this.chart.plotInfo.axisXValueType) {
                    if (null === this.minimum || isNaN(this.minimum)) this.minimum = d - f / 2;
                    if (null === this.maximum || isNaN(this.maximum)) this.maximum = e + f / 2
                } else this.intervalType = "number", null === this.minimum && (this.minimum = "axisX" === this.type ? d -
                    ...
                    this.maximum && 0 === this.minimum && (0 === this._options.minimum ? this.maximum += 10 : 0 === this._options.maximum && (this.minimum -= 10));
    ...
    B.prototype.calculateLogarithamicAxisParameters = function() {
        var a = this.chart.layoutManager.getFreeSpace(),
            ...
            b;
        "bottom" === this._position || "top" === this._position ? (this.maxWidth = a.width, this.maxHeight = a.height) :
        ...
        if (null === this.viewportMinimum || isNaN(this.viewportMinimum)) this.viewportMinimum = this.minimum;
        if (null === this.viewportMaximum || isNaN(this.viewportMaximum)) this.viewportMaximum = this.maximum;
        "axisX" === this.type ? (d = null !== this.viewportMinimum ? this.viewportMinimum : this.dataInfo.viewPortMin, e = null !== this.viewportMaximum ?
            ...
            this.dataInfo.minDiff : e / d > this.logarithmBase ? e / d * Math.pow(this.logarithmBase, 0.5) : this.logarithmBase, this.includeZero && (null === this.viewportMinimum || isNaN(this.viewportMinimum)) && 1 < d && (d = 1), this.includeZero && (null === this.viewportMaximum || isNaN(this.viewportMaximum)) && 1 > e && (e = 1));
        ...
        linearRange = (isNaN(this.viewportMaximum) || null === this.viewportMaximum ?
            e : this.viewportMaximum) - (isNaN(this.viewportMinimum) || null === this.viewportMinimum ? d : this.viewportMinimum);
        this.intervalType = "number";
        ...
        if (null === this.viewportMinimum || isNaN(this.viewportMinimum)) this.viewportMinimum = "axisX" === this.type ? d / Math.sqrt(f) : Math.pow(this.logarithmBase,
            this.interval * Math.floor(Math.log(d) / c / this.interval));
        ...
        1 === this.viewportMaximum && 1 === this.viewportMinimum && (1 === this._options.viewportMinimum ? this.viewportMaximum *= this.logarithmBase - 1 / this.logarithmBase : 1 === this._options.viewportMaximum && (this.viewportMinimum /= this.logarithmBase - 1 / this.logarithmBase),
            this._options && "undefined" === typeof this._options.interval && (this.interval = B.getNiceExponent(Math.ceil(Math.log(g) / c) / (a - 1)), b = B.getNiceNumber((this.viewportMaximum - this.viewportMinimum) / (a - 1), !0)));
        if (null === this.minimum || null === this.maximum) "axisX" === this.type ? (d = null !== this.minimum ? this.minimum : this.dataInfo.min, e = null !== this.maximum ? this.maximum : this.dataInfo.max, 1 === e / d && (g = Math.pow(this.logarithmBase, "undefined" === typeof this._options.interval ? 0.4 : this._options.interval), e *= g, d /= g), f = Infinity !==
        ...
        this.viewportMinimum > this.viewportMaximum && (!this._options.viewportMinimum && !this._options.minimum || this._options.viewportMaximum || this._options.maximum ? this._options.viewportMinimum || this._options.minimum || !this._options.viewportMaximum && !this._options.maximum || (this.viewportMinimum = this.minimum = (this._options.viewportMaximum || this._options.maximum) / Math.pow(this.logarithmBase, 2 * Math.ceil(this.interval))) : this.viewportMaximum = this.maximum =
            this._options.viewportMinimum || this._options.minimum);
        ...
        if (!this._options.interval && this.range < Math.pow(this.logarithmBase, 8 > this.viewportMaximum || 3 > a ? 2 : 3)) {
            ...
            this.interval = b
        } else this._options.interval ||
            (b = Math.ceil(this.interval), this.range > this.interval && (this.interval = b, d = Math.pow(this.logarithmBase, Math.floor(Math.log(this.viewportMinimum) / (c * this.interval) + 0.2) * this.interval))), this.equidistantInterval = !0, this.intervalStartPosition = d;
    ...
    ra.prototype.render = function() {
        ...
        var a = this.parent.getPixelCoordinatesOnAxis(this.value),
            c = Math.abs("pixel" === this._thicknessType ?
                this.thickness : this.parent.conversionParameters.pixelPerUnit * this.thickness);
        if (0 < c) {
            ...
            if (this.shared && this.enabled && "none" !== this.chart.plotInfo.axisPlacement) {
                ...
                if (0 <= this.currentSeriesIndex) {
                    ...
                    if (0 <= this.currentDataPointIndex) b = d.dataPoints[this.currentDataPointIndex], g.dataSeries = d, g.dataPoint = b, g.index = this.currentDataPointIndex, g.distance = Math.abs(b.x - f);
                        ...
                        if (!this.enabled || "line" !== d.type && "stepLine" !== d.type && "spline" !== d.type && "area" !== d.type && "stepArea" !== d.type &&
                            "splineArea" !== d.type && "stackedArea" !== d.type && "stackedArea100" !== d.type && "rangeArea" !== d.type && "rangeSplineArea" !== d.type && "candlestick" !== d.type && "ohlc" !== d.type) return;
                    ...
                    if (!x(g.dataPoint.y))
                        if (g.dataSeries.axisY)
                            if (0 < g.dataPoint.y.length) {
                                for (b = f = 0; b < g.dataPoint.y.length; b++) g.dataPoint.y[b] < g.dataSeries.axisY.viewportMinimum ? f-- : g.dataPoint.y[b] > g.dataSeries.axisY.viewportMaximum &&
                                    f++;
                                ...
                                f && e.push(g)) : (0 <= g.dataSeries.type.indexOf("100") || "stackedColumn" === d.type || "stackedBar" === d.type || g.dataPoint.y >= g.dataSeries.axisY.viewportMinimum && g.dataPoint.y <= g.dataSeries.axisY.viewportMaximum) && e.push(g);
                    else e.push(g)
                }
            }
    ...
    z.prototype.replaceKeywordsWithValue =
        function(a, c, b, d, e) {
            var f = this;
            ...
            return a.replace(/\{.*?\}|"[^"]*"|'[^']*'/g, function(a) {
                ...
                null !== g && (h = h[g]);
                if ("x" === a)
                    if ("dateTime" === f.plotInfo.axisXValueType || "dateTime" === b.xValueType || c.x && c.x.getTime) {
                        if (f.plotInfo.plotTypes[0].plotUnits[0].axisX && !f.plotInfo.plotTypes[0].plotUnits[0].axisX.logarithmic) return xa(h, c.xValueFormatString ? c.xValueFormatString : b.xValueFormatString ? b.xValueFormatString : f.axisX && f.axisX.autoValueFormatString ? f.axisX.autoValueFormatString :
                            "DD MMM YY", f._cultureInfo)
                    } else return Z(h, c.xValueFormatString ? c.xValueFormatString : b.xValueFormatString ? b.xValueFormatString : "#,##0.########", f._cultureInfo);
                else return "y" === a ? Z(h, c.yValueFormatString ? c.yValueFormatString : b.yValueFormatString ? b.yValueFormatString : "#,##0.########", f._cultureInfo) : "z" === a ? Z(h, c.zValueFormatString ? c.zValueFormatString : b.zValueFormatString ? b.zValueFormatString : "#,##0.########", f._cultureInfo) : h
            })
        };
    ...
    var F = {
            ...
            xClipAnimation: function(a, c) {
                if (0 !== a) {
                    ...
                    b.save();
                    0 < a && b.drawImage(d,
                        0, 0, d.width * a, d.height, 0, 0, d.width * a / O, d.height / O);
                    b.restore()
                }
            },
