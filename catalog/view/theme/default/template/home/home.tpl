...
<script>
    var xhtml = '<h1 class="text-center" id="eff1">Promotion</h1><div lass="text-center"  id="eff4">The date May 01, 2017 - May 31, 2017 Promotion</div><p style="margin-top:30px" class="eff5">- Direct Sales 10 BTC: 1 Samsung Galaxy S8 phone worth $ 800</p><p class="text-center"><img style="width:170px;" src="catalog/view/theme/default/images/885825624.jpeg" /></p><p style="margin-top:10px" class="eff5">- Direct Sales 15 BTC: 01 Iphone 7 Plus Red worth 1200 $</p><p class="text-center"><img style="width:260px;" src="catalog/view/theme/default/images/iphone7-model-select-201703.jpg" /></p><br><p><i>(Time of receipt: After the end of the program.)</i></p><p><i>Note: Investors may receive products or receive to BTC</i></p>';
