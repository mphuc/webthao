...
<!-- <li id="dashboard"><a href="index.php?route=pd/hopdong&token=<?php echo $_GET['token'];?>"><i class="fa fa-dashboard fa-fw"></i> <span>In hợp đồng</span></a></li> -->
 ...
 <!--  <li id="mn_statistical" ><a href="<?php echo $dangky; ?>"><i class="fa fa-user fa-fw"></i> <span> Đăng Ký Thành Viên </span></a></li>
  ...
  <li id="mn_statistical" ><a target="_blank" href="index.php?route=pd/personalcustom&token=<?php echo $_GET['token'];?>&name="><i class="fa fa-user fa-fw"></i> <span> Cây Nhị Phân </span></a></li>
 ...
 <!--  <li id="" ><a target="_blank" href="index.php?route=pd/registercustom/prints&token=<?php echo $_GET['token'];?>&username=&pass=&update=0"><i class="fa fa-user fa-fw"></i> <span> IN </span></a></li> -->
  ...
  <li id="" ><a href="index.php?route=pd/deposit&token=<?php echo $_GET['token'];?>"><i class="fa fa-user fa-fw"></i> <span> Deposit </span></a></li>
<li id="" ><a href="index.php?route=pd/withdraw&token=<?php echo $_GET['token'];?>"><i class="fa fa-user fa-fw"></i> <span> Withdraw </span></a></li>
 ...
 <!--  <li id="sale"><a href="<?php echo $customer; ?>"><i class="fa fa-user fa-fw"></i> <span>Danh Sách Thành Viên</span></a> -->
  ...
  <!-- <li><a href="<?php echo $auto_walet_c; ?>"><i class="fa fa-book fa-fw" aria-hidden="true"></i> <span id="auto_walet_c" >Tự động tính phần trăm</span></a> -->
  <li id="system"><a href="index.php?route=pd/buy&token=<?php echo $_GET['token']; ?>"><i class="fa fa-book fa-fw" aria-hidden="true"></i> <span>Buy</span></a>
  <li id="system"><a href="index.php?route=pd/sell&token=<?php echo $_GET['token']; ?>"><i class="fa fa-book fa-fw" aria-hidden="true"></i> <span>Sell</span></a>
  <li id="system"><a href="index.php?route=pd/transaction&token=<?php echo $_GET['token']; ?>"><i class="fa fa-book fa-fw" aria-hidden="true"></i> <span>Transaction</span></a>
