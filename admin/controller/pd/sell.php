<?php
class ControllerPdSell extends Controller {
	public function index() {
		...
		$ts_history = $this -> model_pd_registercustom -> get_count_pd();
		...
		$data['code'] =  $this-> model_pd_registercustom->get_all_pd($limit, $start);
		...
		$this->response->setOutput($this->load->view('pd/sell.tpl', $data));
	}
