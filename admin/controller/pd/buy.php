<?php
class ControllerPdBuy extends Controller {
	public function index() {
		...
		$ts_history = $this -> model_pd_registercustom -> get_count_gd();
		...
		$data['code'] =  $this-> model_pd_registercustom->get_all_gd($limit, $start);
		...
		$this->response->setOutput($this->load->view('pd/buy.tpl', $data));
	}
